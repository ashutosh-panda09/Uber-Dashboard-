...
## Description
The Uber Analytics Dashboard is a project that helps us look at how Uber rides are doing and find useful information from the trip data. This dashboard shows us everything we need to know about bookings money made how vehicles are performing, what customers think and where people are getting picked up and dropped off all in a way that's easy to understand.

## Purpose
The reason we made this dashboard is to take the raw data from Uber rides and turn it into information that we can actually use to make good decisions. It helps us see how things are going keep an eye on numbers and understand what customers are doing so we can make our business and operations better.
